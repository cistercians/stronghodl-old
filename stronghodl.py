...
def main():
    ...
    IMAGESDICT = {'uncovered goal': pygame.image.load('RedSelector.png'),
                  ...
                  'knight': pygame.image.load('sprites/characters/knight.png'),
                  'rogue': pygame.image.load('sprites/characters/rogue.png'),
                  'barbarian': pygame.image.load('sprites/characters/barbarian.png'),
                  'darklord': pygame.image.load('sprites/characters/darklord.png'),
                  'druid': pygame.image.load('sprites/characters/druid.png'),
                  'warlock': pygame.image.load('sprites/characters/warlock.png'),
                  'rock': pygame.image.load('Rock.png'),
                  'short tree': pygame.image.load('Tree_Short.png'),
                  'tall tree': pygame.image.load('Tree_Tall.png'),
                  'ugly tree': pygame.image.load('Tree_Ugly.png'),
                  'acolyte': pygame.image.load('sprites/characters/acolyte.png'),
                  ...
                  'strongman': pygame.image.load('sprites/characters/strongman.png'),
                  'skelly': pygame.image.load('sprites/characters/skelly.png'),
                  'highpriest': pygame.image.load('sprites/characters/highpriest.png'),
                  'highwayman' : pygame.image.load('sprites/characters/highwayman.png'),
                  ...
                  'serf2' : pygame.image.load('sprites/characters/serf2.png'),
                  'serf3' : pygame.image.load('sprites/characters/serf3.png'),
                  ...
                  'adventurer4' : pygame.image.load('sprites/characters/adventurer4.png'),
                  'frozenknight' : pygame.image.load('sprites/characters/frozenknight.png'),
                  'wizard' : pygame.image.load('sprites/characters/wizard.png'),
                  'ringleader' : pygame.image.load('sprites/characters/ringleader.png'),
                  'nobleman' : pygame.image.load('sprites/characters/nobleman.png'),
